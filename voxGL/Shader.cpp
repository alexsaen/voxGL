...
ShaderProgram::ShaderProgram(): programID(0), vertexShader(0), fragmentShader(0), geometryShader(0) {
}
...
void ShaderProgram::attach(VertexShader *vShader, FragmentShader *fShader, GeometryShader *gShader) {
	if(!programID) 
